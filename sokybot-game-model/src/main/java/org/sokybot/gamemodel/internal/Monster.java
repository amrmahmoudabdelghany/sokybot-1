...
public class Monster extends Fighter implements IMonster {
    ...
    public Monster(MonsterData data) {
        ...
        // Old Monster had separate maxHP field? Let's check old Monster.java found in Step 56.
        // Yes: private int maxHP; private int level;
        // And Fighter had maxHP too. This shadows it. 
        // I should probably clean this up, but to be safe I'll keep the shadowing if logic depends on it, OR assume Fighter's is enough.
        // Fighter sets maxHP in constructor from MonsterData.
        // So I can remove the shadowed field in Monster if Fighter handles it.
        // But let's stick to strict copy for now to avoid bugs, unless I see obvious refactor.
