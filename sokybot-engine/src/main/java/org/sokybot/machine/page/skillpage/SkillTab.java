...
public class SkillTab extends JPanel implements ItemListener, ListSelectionListener, ActionListener {
	...
	protected static class MasteryEntry {
		...
		public MasteryEntry(int id, String name) {
			this.id = id;
			this.name = name;
		}
	...
	protected static class MonsterTypeEntry {
		...
		// Explicit constructor for compilation
		public MonsterTypeEntry(String name, MonsterType type) {
			this.name = name;
			this.type = type;
		}
	...
	protected static class SkillTableEntry { 
		...
		// Explicit constructor for compilation
		public SkillTableEntry(Icon skillIcon, String skillName, int skillLvl) {
