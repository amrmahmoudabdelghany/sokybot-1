...
class GroupContextImplTest extends RuntimeTestBase {
    ...
    @Test
    void testGetRuteFinder() {
        IRuteFinder finder = groupContext.getRuteFinder();
        
        assertNotNull(finder);
        assertEquals(mockRuteFinder, finder);
        verify(mockRuteFinderFactory, times(1)).createRuteFinder(mockGameDataLookup);
    }
    
    @Test
    void testGetRuteFinderCached() {
        IRuteFinder finder1 = groupContext.getRuteFinder();
        IRuteFinder finder2 = groupContext.getRuteFinder();
