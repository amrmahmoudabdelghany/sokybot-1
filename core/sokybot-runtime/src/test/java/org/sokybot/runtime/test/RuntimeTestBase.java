...
public abstract class RuntimeTestBase {
    ...
    @Mock
    protected IRouteFinderFactory mockRouteFinderFactory;

    @Mock
    protected IRouteFinder mockRouteFinder;
    ...
    protected void setUp() {
        ...
        mockBundleContext.registerMockService(IRouteFinderFactory.class, mockRouteFinderFactory, null);
        ...
        lenient().when(mockRouteFinderFactory.createRouteFinder(mockGameDataLookup)).thenReturn(mockRouteFinder);
