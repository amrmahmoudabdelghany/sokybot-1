...
public interface IActuator {
    ...
    /**
     * Gets the descriptor containing metadata about this actuator.
     * Override to provide detailed metadata for UI display.
     * 
     * @return The actuator descriptor
     */
    default ActuatorDescriptor getDescriptor() {
        return ActuatorDescriptor.of(getName());
    }
}
