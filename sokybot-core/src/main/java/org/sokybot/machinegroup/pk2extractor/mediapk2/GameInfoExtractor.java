...
import org.sokybot.machinegroup.gamemodel.Division;
...
import org.sokybot.machinegroup.pk2extractor.exception.Pk2InvalidResourceFormatException;
...
public class GameInfoExtractor implements IExtractor{
	...
	@Autowired
	public GameInfoExtractor(@Value("${"+ AppConstants.GAME_PATH + "}")  String gamePath  , GameInfoRepo repo) { 
		this.gamePath = gamePath ; 
		this.gameInfoRepo = repo ; 
	}
	...
	this.gameInfoRepo.save(gameInfo) ; 
