...
import org.sokybot.gameevents.events.combat.*;
...
// Some events might be in other packages, checking grep output first is wise but I will guess-and-fix based on naming conventions if grep output is truncated.
import org.sokybot.gameevents.events.spawn.*;
...
class TranslatorTest {
    ...
    void testEquipItemTranslator() {
        // Build mock packet: entityId (int) + slot (byte) + itemRefId (int) + optLevel
        // (byte)
    ...
    void testDamageEffectTranslatorNormal() {
        ...
        DamageEffectTranslator translator = new DamageEffectTranslator(mockLookup);
        DamageEffectEvent event = (DamageEffectEvent) translator.translate(MACHINE_NAME, createPacket(bb.array()))
                .get(0);
    ...
    void testStatPointsUpdateTranslatorFailed() {
        ...
        StatPointsUpdateEvent event = (StatPointsUpdateEvent) translator
                .translate(MACHINE_NAME, createPacket(bb.array())).get(0);
    ...
    void testExchangeConfirmedTranslatorSelf() {
        ...
        ExchangeConfirmedEvent event = (ExchangeConfirmedEvent) translator
                .translate(MACHINE_NAME, createPacket(bb.array())).get(0);
    ...
    void testExchangeApprovedTranslator() {
        ...
        ExchangeApprovedEvent event = (ExchangeApprovedEvent) translator
                .translate(MACHINE_NAME, createPacket(bb.array())).get(0);
    ...
    void testExchangeUpdateTranslator() {
        // Build mock packet: exchangeId + updatedBy + slot + itemRefId + quantity +
        // goldAmount
        ...
        ExchangeUpdateEvent event = (ExchangeUpdateEvent) translator.translate(MACHINE_NAME, createPacket(bb.array()))
                .get(0);
    ...
    void testPartyMatchingTranslatorCreated() {
        ...
        PartyMatchingEvent event = (PartyMatchingEvent) translator.translate(MACHINE_NAME, createPacket(bb.array()))
                .get(0);
    ...
    void testItemOwnershipRemovedTranslator() {
        ...
        ItemOwnershipRemovedEvent event = (ItemOwnershipRemovedEvent) translator
                .translate(MACHINE_NAME, createPacket(bb.array())).get(0);
    ...
    void testQuestAbandonTranslator() {
        ...
        QuestAbandonEvent event = (QuestAbandonEvent) translator.translate(MACHINE_NAME, createPacket(bb.array()))
                .get(0);
    ...
    void testCelestialPositionTranslator() {
        ...
        CelestialPositionEvent event = (CelestialPositionEvent) translator
                .translate(MACHINE_NAME, createPacket(bb.array())).get(0);
    ...
    void testWeatherUpdateTranslator() {
        ...
        WeatherUpdateEvent event = (WeatherUpdateEvent) translator.translate(MACHINE_NAME, createPacket(bb.array()))
                .get(0);
    ...
    void testChatRestrictTranslator() {
        ...
        ChatRestrictEvent event = (ChatRestrictEvent) translator.translate(MACHINE_NAME, createPacket(bb.array()))
                .get(0);
