...
import org.sokybot.gamemodel.snapshot.IPlayerSnapshot;

public final class PlayerSnapshot implements IPlayerSnapshot {
    ...
    private PlayerSnapshot(IPlayer live) {
    ...
    public static PlayerSnapshot of(IPlayer live) {
        return new PlayerSnapshot(live);
    }
