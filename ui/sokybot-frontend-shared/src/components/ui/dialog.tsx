...
const DialogOverlayImpl = DialogPrimitive.Overlay as any
const DialogContentImpl = DialogPrimitive.Content as any
const DialogTitleImpl = DialogPrimitive.Title as any
const DialogDescriptionImpl = DialogPrimitive.Description as any
