...
public class WebviewConfigurator implements IWebviewConfigurator {
    ...
    @Override
    public void registerActionHandler(String pageId,
    ...
    @Override
    public void registerToolbarActionHandler(String actionId,
            BiFunction<String, Map<String, Object>, Map<String, Object>> handler) {
    ...
    public Flux<Map<String, Object>> handleStream(String pageId, String streamId, Map<String, Object> params) {
        String key = pageId + ":" + streamId;
        StreamRegistration registration = streamHandlers.get(key);
        if (registration != null && registration.handler != null) {
            return registration.handler.apply(params);
        }
        logger.warn("No stream handler found for page: {}, stream: {}", pageId, streamId);
        return Flux.empty();
    }
