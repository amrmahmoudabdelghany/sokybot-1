...
public interface IWebviewConfigurator {
     ...
     * @param modalSchema UI schema for the modal dialog (same format as page
     *                    schema)
     */
    ...
    /**
     * Register a handler for actions triggered from within a toolbar action's
     * modal.
     * 
     * @param actionId Toolbar action identifier
     * @param handler  Function that takes action name and data, returns response
     */
    void registerToolbarActionHandler(String actionId,
    ...
    /**
     * Get the entire extension registry (pages and toolbar actions).
     * 
     * @return Map containing registry data
     */
    Map<String, Object> getExtensionRegistry();

    /**
     * Handle a schema request for a page.
     * 
     * @param pageId  Page identifier
     * @param request Request string (e.g., machineId)
     * @return Schema/data map
     */
    Map<String, Object> handleSchemaRequest(String pageId, String request);

    /**
     * Handle a user action from a page.
     * 
     * @param pageId Page identifier
     ...
     * @return Response map
     */
    Map<String, Object> handleAction(String pageId, String action, Map<String, Object> data);
     ...
     * @return Response map
     */
    Map<String, Object> handleToolbarAction(String actionId, String action, Map<String, Object> data);
     ...
     * @return Flux of data
     */
    Flux<Map<String, Object>> handleStream(String pageId, String streamId, Map<String, Object> params);
}
