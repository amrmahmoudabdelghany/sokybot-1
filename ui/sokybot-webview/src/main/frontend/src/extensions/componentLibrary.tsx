...
export const UIComponentLibrary: Record<string, React.ComponentType<any>> = {
    ...
    // --- More shadcn primitives (JSON `type` names) ---
    'Popover': Popover,
    ...
    'TableHeaderPrimitive': TableHeader,
    'TableBodyPrimitive': TableBody,
    'TableFooterPrimitive': TableFooter,
    'TableHeadPrimitive': TableHead,
    'TableRowPrimitive': TableRow,
    'TableCellPrimitive': TableCell,
    'TableCaptionPrimitive': TableCaption,
