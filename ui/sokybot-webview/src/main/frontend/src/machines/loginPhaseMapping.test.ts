...
describe('mapPhaseToUX', () => {
    ...
    it.each([
        ...
        ['GATEWAY_CONNECTED', 1, 'info', 'not_started', false],
        ...
        ['AGENTS_RECEIVED', 2, 'info', 'not_started', false],
        ['REDIRECTING', 2, 'info', 'not_started', false],
        ['AGENT_CONNECTED', 3, 'info', 'in_progress', false],
        ...
        ['LOGIN_SUCCESS', 3, 'info', 'in_progress', false],
        ['AUTH_SENT', 3, 'info', 'in_progress', false],
        ['WAIT_FOR_CAPTCHA', 3, 'warn', 'in_progress', false],
        ['PASSCODE_SUBMITTED', 3, 'info', 'in_progress', false],
    ...
    it('all known phases have progressStep in 1-4', () => {
        const phases = [
            'DISCONNECTED', 'MISSING_GATEWAY', 'PENDING_MANUAL_CONNECT', 'CONNECTING_GATEWAY', 'GATEWAY_CONNECTED',
            'WAITING_FOR_AGENTS', 'WAITING_FOR_AGENTS_TIMEOUT', 'MISSING_AGENT_SERVER', 'AGENTS_RECEIVED',
            'REDIRECTING', 'AGENT_CONNECTED', 'SERVER_INSPECTION',
            'MISSING_CREDENTIALS', 'LOGIN_SENT', 'LOGIN_SUCCESS', 'AUTH_SENT', 'WAITING_FOR_PASSCODE',
            'WAIT_FOR_CAPTCHA', 'PASSCODE_SUBMITTED', 'IN_QUEUE',
