...
// import org.sokybot.swing.SokyBotIcons; // Assume icons available or use text/placeholder

public class SkillTabComponentFactory {

    private SkillTab skillTab;

    public SkillTabComponentFactory(SkillTab tab) {
        this.skillTab = tab;
    }

    public Component createSkillTableBox() {
        this.skillTab.comMasteryFilter = new JComboBox<>();
    ...
    public Component createBuffSkillBox() {
        this.skillTab.comBuffSkillFilter = new JComboBox<>();
        ...
        this.skillTab.btnAddBuffSkill = new JButton("Add"); // Placeholder for Icon
        this.skillTab.btnRemoveBuffSkill = new JButton("Rem");
        this.skillTab.btnMoveUpBuffSkill = new JButton("Up");
        this.skillTab.btnMoveDownBuffSkill = new JButton("Down");
    ...
    public Component createAttackSkillBox() {
        this.skillTab.comAttackSkillFilter = new JComboBox<>();
        ...
        this.skillTab.btnAddAttackSkill = new JButton("Add");
        this.skillTab.btnRemoveAttackSkill = new JButton("Rem");
        this.skillTab.btnMoveUpAttackSkill = new JButton("Up");
        this.skillTab.btnMoveDownAttackSkill = new JButton("Down");
        ...
        this.skillTab.btnSaveAttackSkill = new JButton("Save");
        this.skillTab.btnSaveAttackSkill.setActionCommand("Save");
        this.skillTab.btnSaveAttackSkill.addActionListener(this.skillTab);
        ...
        btnBox.add(Box.createVerticalStrut(4));
        btnBox.add(this.skillTab.btnSaveAttackSkill);
        btnBox.add(Box.createGlue());
    ...
    public Component createSettingBox() {
        JPanel panel = new JPanel();
        panel.setBorder(BorderFactory.createTitledBorder("Settings"));
        return panel;
    }

    private Component makeTitle(Component comp, String title) {
