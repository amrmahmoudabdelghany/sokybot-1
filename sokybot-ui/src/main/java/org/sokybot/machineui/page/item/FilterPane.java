...
public class FilterPane extends JPanel {
    ...
    private JPanel createGeneralBox() {
        ...
        int border = 5;
        double size[][] = { { border, 0.25, 0.25, 0.25, border }, { border, 0.25, 0.25, 0.25, 0.25, border } };
    ...
    private JPanel createAccessoryBox() {
        JPanel box = new JPanel();
        int border = 5;
        double size[][] = { { border, 0.25, 0.25, 0.25, border }, { border, TableLayout.PREFERRED, border } };
        box.setLayout(new TableLayout(size));
    ...
    private JPanel createWeaponBox() {
        JPanel box = new JPanel();
        int border = 5;
        double size[][] = { { border, 0.25, 0.25, 0.25, border }, 
                { border, TableLayout.PREFERRED, TableLayout.PREFERRED, border, TableLayout.PREFERRED,
                        TableLayout.PREFERRED, TableLayout.PREFERRED, border } };
        box.setLayout(new TableLayout(size));
